...
const PaymentSuccess = () => {
    ...
    const handleNavigateToCourses = () => {
        router.replace('/pages/student/course');
    };
        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="flex-1 bg-white-100 py-16 px-6">
                <div className="flex flex-col items-center justify-center bg-white-100">
                    <h1 className="text-3xl font-semibold text-[#6E40FF] mb-6">Payment Successful!</h1>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                        ...
                        <button
                            ...
                            className="w-full py-2 bg-[#6E40FF] text-white rounded-[0px] hover:bg-[#6E40FF] transition-colors"
                        >
