...
const MentorForgetPassword = () => {
    ...
    const onSubmit: SubmitHandler<MentorForgetCredentials> = async (data) => {
        try {
            const response = await mentorApis.forgetPass(data)
            if (response) {
                        ...
                        <div className="mb-4">
                         ...
                         <div className="mb-4">
                                ...
                                <input
                                    type="password"
                                    id="confirmPassword"
                                    className="w-full p-3 border border-gray-300 bg-white rounded-md rounded-none focus:outline-none focus:border-[#433D8B]"
...
export default MentorForgetPassword
