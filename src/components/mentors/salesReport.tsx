...
const MentorSalesReport = () => {
    ...
    const fetchReport = async () => {
        try {
            ...
            const response = await axios.get(`${MENTOR_SERVICE_URL}/get/mentor/report?${queryString}`, {
    ...
    const exportToPDF = () => {
        ...
        doc.autoTable({
            ...
            head: [['Course Name', 'Buyer Name', 'Purchased At', 'Price', 'Transaction ID']],
            ...
            <div className="flex flex-col min-h-screen">
                ...
                <div className="flex justify-center items-center gap-4 my-6">
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg ${currentPage === 1 ? "bg-gray-300 cursor-not-allowed" : "bg-[#433D8B] text-white hover:bg-[#352e77]"
                            }`}
                    >
                        Previous
                    </button>
                    ...
                    <div className="flex gap-2">
                        {Array.from({ length: totalPages }, (_, index) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg ${currentPage === index + 1 ? "bg-[#433D8B] text-white" : "bg-gray-200 hover:bg-gray-300"
                                    }`}
                            >
                                {index + 1}
                            </button>
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg ${currentPage === totalPages ? "bg-gray-300 cursor-not-allowed" : "bg-[#433D8B] text-white hover:bg-[#352e77]"
                            }`}
                    >
                        Next
                    </button>
...
export default MentorSalesReport;